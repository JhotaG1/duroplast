    ...
    <div className="home">
      <header className="hero">
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <Link to="/box-liners" className="btn-primary">View Products</Link>
            <Link to="#" className="btn-outline">Talk to an Expert</Link>
          </div>
        </div>
      </header>
      ...
      <section className="section-wrapper container">
        ...
        <div className="categories-grid">
          <Link to="/box-liners" className="category-card">
